...
export function calculateTax(income) {
  let amount=0;
   if (income>=0 && income <=10000) amount=0
   if (income>10000 && income <=30000) amount = (income-10000) * 0.1
   if (income>30000 && income <=70000) amount = (20000) * 0.1 + (income-30000)*0.2
   if (income>70000) amount = (20000) * 0.1 + (income-70000)*0.3 + 40000 * 0.2
